//  ========================================================================
//  COSC363: Computer Graphics;  University of Canterbury (2018)
//
...
void initialize()
{
	...
	glm::vec4 lightWorld = glm::vec4(20.0, 10.0, 20.0, 1.0);     //Light's position in world coordinates
	projMatrix = glm::perspective(60.0f*CDR, 1.0f, 10.0f, 40.0f);
	viewMatrix =      //Create a view matrix using GLM function lookAt

	glm::vec4 lightEye =  //Light's position in eye coordinates
...
void display()
{
	...
	glm::mat4 mvMatrix =    //The model-view matrix
	glm::mat4 mvpMatrix =  //The model-view-projection matrix
